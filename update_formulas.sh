...
if [ $? -eq 0 ]; then
  ...
  ls -la "$(dirname "$0")/Formula/mq.rb" "$(dirname "$0")/Formula/mq-lsp.rb" "$(dirname "$0")/Formula/mq-mcp.rb" "$(dirname "$0")/Formula/mq-crawl.rb"

  echo "Created versioned formulas:"
  ls -la "$(dirname "$0")/Formula/mq@$VERSION.rb" "$(dirname "$0")/Formula/mq-lsp@$VERSION.rb" "$(dirname "$0")/Formula/mq-mcp@$VERSION.rb" "$(dirname "$0")/Formula/mq-crawl@$VERSION.rb" 2>/dev/null || echo "No versioned formulas found."
else
